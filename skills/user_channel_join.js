            ...
            if (!user || typeof user == 'undefined') {
                bot.startPrivateConversation({ user: message.user }, function (err, convo) {
                    ...
                    controller.storage.teams.get(message.team, function (err, team) {
                        ...
                        convo.say("Third, the most important part of having me around is completing your daily questionnaires because, without your questionnaires filled out, nothing else matters! It's sometimes difficult to remember to carry them out, so let's set up a time for me to send them automatically everyday...");
                ...
                bot.say({
                    ...
                    text: "Thanks for joining the Internal channel! I'm positive that you'll have a better day knowing how your teammates are feeling :relaxed:"
                });
            }
        })
    })
