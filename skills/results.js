        ...
        const content = {
            blocks: [
                ...
                },
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "*Positive:* " + sleepPositiveOutcome + "\n*Negative:* " + sleepNegativeOutcome + "\n" + sleepMessage + "\n\n*Energy*"
                    }
                },
                {
                    "type": "divider"
                },
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "*Positive:* " + energyPositiveOutcome + "\n*Negative:* " + energyNegativeOutcome + "\n" + energyMessage + "\n\n*Mood*"
                    }
                },
                {
                    "type": "divider"
                },
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "*Positive:* " + moodPositiveOutcome + "\n*Negative:* " + moodNegativeOutcome + "\n" + moodMessage + "\n\n*Motivation*"
                    }
                },
                {
                    "type": "divider"
                },
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "*Positive:* " + motivationPositiveOutcome + "\n*Negative:* " + motivationNegativeOutcome + "\n" + motivationMessage + "\n\n*Efficiency*"
                    }
                },
                {
                    "type": "divider"
                },
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "*Positive:* " + efficiencyPositiveOutcome + "\n*Negative:* " + efficiencyNegative + "\n" + efficiencyMessage + "\n\n*Fulfillment*"
                    }
                },
                {
                    "type": "divider"
                },
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": "*Positive:* " + fulfillmentPositiveOutcome + "\n*Negative:* " + fulfillmentNegativeOutcome + "\n" + fulfillmentMessage + "\n\n*Overall*"
                    }
                },
                {
                    "type": "divider"
