module.exports = function (controller) {
    controller.hears(['report', 'Report'], 'direct_message', function (bot, message) {
                ...
                if (convo.successful()) {
                    controller.storage.users.get(message.user, function (err, user) {
                        ...
                        controller.storage.teams.get(message.team, function (err, team) {
                            ...
                            if (style == 'Personal') {
                                var results = getReport(user, timeframe, style);
                                ...
                                var results = teamReport(data, timeframe, style);
                                var text = "Here is the " + timeframe + " report for " + channel_name;
                            } else {
                                var results = teamReport(team, timeframe, style);
