module.exports = function (controller) {
    controller.hears(['Search History', 'search history'], 'direct_message, direct_mention', function (bot, message) {
                ...
                controller.storage.users.find({ team: message.team }, function (err, all_users) {
                    bot.startConversation(message, function (err, convo) {
                        ...
                        convo.on('end', function (convo) {
                            var results = getOutput(all_users, dates);
                            if (convo.successful()) {
...
function getOutput(results, dates) {
