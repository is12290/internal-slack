            ...
            if (typeof info.status != 'undefined' && info.status == 'top' || info.status == 'mid') {
                if (!info || typeof info.customization == 'undefined' || typeof info.customization.reporting == 'undefined') {
                    bot.startConversation(message, function (err, convo) {
                        ...
                        convo.addMessage({ text: "Hey! Let's get your automatic reporting all set up..." });
                    ...
                    bot.reply(message, "Hm, would you mind trying again? My hearing is spotty right now");
                }
            } else {
                bot.reply(message, "Automatic team reporting is a feature only available to paid subscribers! Check out plans on our website: https://getinternal.co");
            }
        });
    })
}