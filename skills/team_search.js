module.exports = function (controller) {
    controller.hears(['^historic team search', '^historic Team Search', '^historical team search', '^historical Team Search', '^team search', '^team Search'], 'direct_message', function (bot, message) {
