...
if (process.env.MONGODB_URI) {
    var mongoStorage = require('botkit-storage-mongo')({mongoUri: process.env.MONGODB_URI, tables: ['results', 'week', 'personal']});
...
// Send reminders
require(__dirname + '/components/reminders.js')(controller);